...
//	2010.12: entire code written: Lukasz G. Szafaryn
//	2011.11: converted to OpenCL: Lukasz G. Szafaryn
...
#include "./common.h"								// (in directory)						main function header
...
#include "./util/timer/timer.h"						// (in directory)						timer function header
#include "./util/num/num.h"							// (in directory)						number function header

//======================================================================================================================================================150
//	KERNEL
//======================================================================================================================================================150

#include "./kernel/kernel_gpu_opencl_wrapper.h"		// (in directory)						opencl wrapper function header
...
#include "./main.h"									// (in directory)						main function header
		...
		char *argv [])
{
	...
	for(i=0; i<dim_cpu.space_elem; i=i+1){
		...
		// (enable for testing purposes only - initialize inputs with real numbers for comparison across runs)
