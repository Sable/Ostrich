...
for iter = 1:iterations
    ...
    calc_beta(a,b,nstates,length,beta,scale);
    calc_gamma_sum(gamma_sum,nstates,length,alpha,beta);
    calc_xi_sum(xi_sum,a,b,alpha,beta,obs,nstates,length);
    estimate_a(a,c,alpha,beta,xi_sum,gamma_sum,ones_n,length,nstates);
    estimate_b(b,c,alpha,beta,gamma_sum,ones_s,obs,length,nstates);
    estimate_pi(pi,alpha,beta,nstates);
