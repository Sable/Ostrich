function calc_xi_sum(xi_sum,a,b,alpha,beta,obs,nstates,length)
for t = 1:length-1
    ...
    for i = 1:nstates
        for j = 1:nstates
            ...
            xi_sum(offsetj) = xi_sum(offsetj) + alpha(offset + j) * a(offsetj + i) * b((obs(t+2)-1)*nstates + i) * beta(t * nstates + i) / sum_ab;
        end
    end
end
end