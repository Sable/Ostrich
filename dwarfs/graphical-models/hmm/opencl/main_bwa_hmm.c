...
int main(int argc, char *argv[])
{
    ...
    if(v_model == 'n')
    {
        ...
        // fprintf(stderr, "Vary states with S = %i, T = %i\n", S, T);
        // fprintf(stderr, "States\tTime (s)\tLog_likelihood\n");
    ...
    } else if(v_model == 's')
    {
        ...
        // fprintf(stderr, "Vary symbols with N = %i, T = %i\n", N, T);
        // fprintf(stderr, "Symbols\tTime (s)\tLog_likelihood\n");
    ...
    } else if(v_model == 't')
    {
        ...
        // fprintf(stderr, "Vary observations with N = %i, S = %i\n", N, S);
        // fprintf(stderr, "Observations\tTime (s)\tLog_likelihood\n");
